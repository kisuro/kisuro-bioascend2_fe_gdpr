...
export function SupplementReviewsModal({ supplement, isOpen, onClose }: SupplementReviewsModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="glass-morph border-white/20 !max-w-[calc(100vw-2rem)] !w-[calc(100vw-2rem)] sm:mx-4 sm:!max-w-4xl sm:!w-auto p-4 sm:p-6 md:p-8 max-h-[90vh] overflow-y-auto">
        <DialogHeader>
