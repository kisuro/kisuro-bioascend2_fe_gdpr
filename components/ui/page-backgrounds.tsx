...
export const BiorhythmsBackground = ({ className = "" }: { className?: string }) => (
  <div className={`absolute inset-0 overflow-hidden pointer-events-none ${className}`}>
    ...
    {/* Secondary wave */}
    <motion.svg
      className="absolute bottom-20 left-0 w-full h-32 text-[#64B5F6]/5"
      viewBox="0 0 1200 100"
      preserveAspectRatio="none"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
    ...
    <motion.div
      className="absolute top-1/3 right-20 w-3 h-3 bg-[#81C784]/15 rounded-full"
      animate={{
        y: [-10, 10, -10],
...
export const SupplementsBackground = ({ className = "" }: { className?: string }) => (
  <div className={`absolute inset-0 overflow-hidden pointer-events-none ${className}`}>
    {/* DNA Helix Structure */}
    <motion.svg
      className="absolute top-20 right-20 w-32 h-64 text-primary/8"
      viewBox="0 0 100 200"
    ...
    <motion.svg
      className="absolute top-40 left-16 w-48 h-48 text-accent/12"
      viewBox="0 0 120 120"
    ...
    {/* Vitamin Molecules */}
    {[
      { x: "70%", y: "20%", size: "w-6 h-6", color: "bg-primary/15", delay: 0 },
      { x: "15%", y: "60%", size: "w-4 h-4", color: "bg-accent/20", delay: 1 },
      { x: "85%", y: "70%", size: "w-5 h-5", color: "bg-chart-2/18", delay: 2 },
    ].map((vitamin, i) => (
      <motion.div
        key={i}
    ...
    <motion.svg
      className="absolute bottom-32 right-32 w-40 h-40 text-muted/6"
      viewBox="0 0 100 100"
    ...
    <motion.svg
      className="absolute top-60 left-1/2 w-64 h-32 text-border/15 -translate-x-1/2"
      viewBox="0 0 200 100"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
...
export const MindBackground = ({ className = "" }: { className?: string }) => (
  <div className={`absolute inset-0 overflow-hidden pointer-events-none ${className}`}>
    ...
    <motion.svg
      className="absolute top-20 left-1/4 w-96 h-32 text-[#E57373]/8"
      viewBox="0 0 400 100"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 2 }}
    ...
    {/* Meditation circles */}
    <motion.svg
      className="absolute bottom-40 right-16 w-48 h-48 text-[#64B5F6]/6"
      viewBox="0 0 200 200"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 3, delay: 1 }}
...
export const AssistantBackground = ({ className = "" }: { className?: string }) => (
  <div className={`absolute inset-0 overflow-hidden pointer-events-none ${className}`}>
    ...
    <motion.svg
      className="absolute top-32 left-20 w-64 h-64 text-[#81C784]/8"
      viewBox="0 0 200 200"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      transition={{ duration: 2 }}
    ...
    {/* Data flow particles */}
    <motion.div
      className="absolute bottom-20 left-1/3 w-2 h-2 bg-[#64B5F6]/15 rounded-full"
      animate={{
        x: [0, 200, 0],
        y: [0, -50, 0],
        opacity: [0, 0.5, 0],
...
export const ProfileBackground = ({ className = "" }: { className?: string }) => (
  <div className={`absolute inset-0 overflow-hidden pointer-events-none ${className}`}>
    ...
    <motion.svg
      className="absolute top-20 right-20 w-32 h-32 text-[#E57373]/6"
      viewBox="0 0 100 100"
      initial={{ opacity: 0, rotate: -45 }}
      animate={{ opacity: 1, rotate: 0 }}
    ...
    <motion.div
      className="absolute bottom-40 left-16 w-4 h-4 bg-[#81C784]/10 rounded-full"
      animate={{
        y: [-15, 15, -15],
        opacity: [0.1, 0.2, 0.1],
      }}
