...
const values = [
  {
    ...
    title: "Honesty",
    description:
      "We believe in transparent, evidence-based information to help you make informed decisions about your health journey.",
    color: "text-red-400",
  },
  {
    icon: Users,
    title: "Community",
    description:
      "Health is better together. We foster a supportive environment where experiences and insights are shared openly.",
    color: "text-blue-400",
  },
  {
    icon: Target,
            ...
            <div className="space-y-8">
              ...
              <div className="prose prose-lg mx-auto text-muted-foreground leading-relaxed space-y-6">
                <p className="text-xl">
                  ...
                  supplements — it's about sleep, nutrition, the state of the body, sport, and how all these factors
                  interact.
                </p>

                <p className="text-lg">
                  We believe it all belongs in one place, enhanced by AI to create a truly personal path to wellness and
                  longevity.
                </p>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed text-lg">
                To become a leading platform for personalized health, where every user can build their unique program
                and path toward a better, longer, and healthier life.
              </p>
            </GlassCard>
          </div>
        </div>
        ...
        <div className="max-w-5xl mx-auto">
          <GlassCard variant="strong" className="p-12 rounded-3xl" animate>
            <div className="text-center mb-12">
              ...
              <h2 className="text-2xl md:text-3xl font-bold mb-6 font-heading">What Makes Us Different</h2>
            </div>

            <div className="prose prose-lg mx-auto text-muted-foreground leading-relaxed space-y-6">
              <p className="text-lg">
                Our holistic approach sets us apart. We don't believe in a single "magic pill" or one-size-fits-all
                solutions. Instead, our platform combines supplements, lifestyle tracking, and AI-driven insights —
                acting like a personal coach that continuously adapts and evolves your program based on your
                individuality.
              </p>
            </div>
          </GlassCard>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            >
              ...
              <p className="text-muted-foreground leading-relaxed mb-6">
                Our team is small but driven — a diverse group of enthusiasts from different backgrounds, ages, and
                beliefs, united by a shared passion for health and technology.
              </p>
            </GlassCard>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            ...
            <div className="prose prose-lg mx-auto text-muted-foreground leading-relaxed space-y-6 mb-8">
              <p className="text-xl">
                Join us. Share your reviews, your experiences, and your journey. Together, we can make the world
